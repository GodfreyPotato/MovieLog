...
class piechartMostComment extends StatefulWidget {
  piechartMostComment({super.key, required this.movies});
  List movies;

  @override
  State<StatefulWidget> createState() => piechartMostCommentState();
}

class piechartMostCommentState extends State<piechartMostComment> {
  int touchedIndex = -1;
  ...
  List<PieChartSectionData> showingSections() {
    ...
    int totalComments = widget.movies.fold(
      0,
      (sum, movie) => sum + (movie['comment_count'] as int),
    );
    ...
    return List.generate(widget.movies.length, (i) {
      ...
      final commentCount = movie['comment_count'] as int;
